...
module rv32i_datapath (
    ...
    logic [31:0] rs1, rs2, alu_result, wb_out;
...
module mux_wb (
    ...
    always_comb begin
        ...
        case (sel)
            ...
            3'b011: wb_out = in3;  //load AUIPC: Add Upper Imm to PC
...
module register_file (
    input logic        clk,     //rs1
    input logic [ 4:0] raddr1,  //rs2
    input logic [ 4:0] raddr2,  //register file write enable
    ...
    assign rdata2 = (raddr2) ? register_file[raddr2] : 32'h0000_0000; //rst필요없음
endmodule
